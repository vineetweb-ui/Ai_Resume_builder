...
const ProfesionalSummary = ({data,onchange,Setresumedata}) => {
    ...
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
          <textarea value={data || ""} onChange={(e)=>onchange(e.target.value)} rows={7} className=' w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring focus:ring-blue-500
           focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights your key strength that highlights your key strengths and career objectives...'/>
