...
const Personalinforform = ({data,onChange,removeBackground,setremoveBackground}) => {
  ...
  return (
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>
                {data.image ?(<img src={typeof data.image==='string' ? data.image : URL.createObjectURL(data.image)} alt='user-image' className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80'></img>)
                :(
        ...
        return(
            ...
            <input type={field.type} value={data[field.key]||""} onChange={(event)=>handleChange(field.key,event.target.value)}
